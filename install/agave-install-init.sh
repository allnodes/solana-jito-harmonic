...
if [ -z "$SOLANA_DOWNLOAD_ROOT" ]; then
    SOLANA_DOWNLOAD_ROOT="https://github.com/allnodes/solana-harmonic/releases/download"
fi
GH_LATEST_RELEASE="https://api.github.com/repos/allnodes/solana-harmonic/releases/latest"
